...
class REPL {
    ...
    get banner(){
        var config = this.config.package;
        config.environment = this.config.environment || process.env.NODE_ENV;
        var _banner = `
------------------------------------
REPL Info:
Name              : ${config.name}
...
`;
    ...
    start(cb){
        ...
        function onConnection(socket){
            ...
            repl.setPrompt('\u001b[1;32ms2-influx-pub > \u001b[0m');
            repl.resume();
