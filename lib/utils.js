...
ansi.wrap = function(a, b, msg) {
    return '\u001b[' + a + 'm' + msg + '\u001b[' + b + 'm';
};

ansi.magenta = function(msg) {
    return ansi.wrap(35, 39, msg);
};

ansi.red = function(msg) {
    return ansi.wrap(31, 39, msg);
};

ansi.cyan = function(msg) {
    return ansi.wrap(36, 39, msg);
};

ansi.yellow = function(msg) {
    return ansi.wrap(33, 39, msg);
};

ansi.bold = function(msg) {
    return ansi.wrap(1, 22, msg);
};

ansi.color = function(acolor, msg) {
    const color = ansi[acolor] || ansi.magenta;
    return color(msg);
};
...
ansi.inverse = function(msg) {
    return ansi.wrap(7, 27, msg);
};
